...
<!-- - 코드 리뷰에서 피드백 받고 싶은 포인트가 있다면 추가로 작성해주세요
  ...
  - 뭘 질문할지 모르겠어요. -->
---
- 커밋 : 동시성 / 파일명 : PointConcurrencyIntegrationTest
- **동시성 테스트가 실패하는 이유를 모르겠습니다.**
    - 테스트 자체에 문제가 있는지, 아니면 서비스 코드가 근본적으로 동시성 상황을 처리하지 못하는 것인지 알고 싶습니다.

- **실제 문제를 명확히 진단하기 위해 테스트에서 어떤 추가적인 로깅 또는 조건이 필요할지도 조언을 받고 싶습니다.**
